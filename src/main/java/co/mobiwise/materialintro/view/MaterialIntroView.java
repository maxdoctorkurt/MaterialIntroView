...
public class MaterialIntroView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        colorTextViewHeader = Constants.DEFAULT_COLOR_TEXTVIEW_INFO;
        focusType = Focus.ALL;
        ...
        textViewHeader = (TextView) layoutInfo.findViewById(R.id.textview_header);
        flGotIt = (FrameLayout) layoutInfo.findViewById(R.id.flGotIt);
        textViewInfo.setTextColor(colorTextViewInfo);
        textViewHeader.setTextColor(colorTextViewHeader);
        ...
        flGotIt.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void setColorTextViewHeader(int colorTextViewHeader) {
        this.colorTextViewHeader = colorTextViewHeader;
        textViewHeader.setTextColor(this.colorTextViewHeader);
    }
    ...
    private void setTextViewHeader(CharSequence textViewHeader) {
        this.textViewHeader.setText(textViewHeader);
    }
    ...
    private void setTextViewHeaderSize(int textViewHeaderSize) {
        this.textViewHeader.setTextSize(TypedValue.COMPLEX_UNIT_SP, textViewHeaderSize);
    }
    ...
    public void setConfiguration(MaterialIntroConfiguration configuration) {
        ...
        if (configuration != null) {
            ...
            this.colorTextViewHeader = configuration.getColorTextViewHeader();
    ...
    public static class Builder {
        ...
        public Builder setHeaderTextColor(int textColor) {
            materialIntroView.setColorTextViewHeader(textColor);
            return this;
        }
        ...
        public Builder setHeaderText(CharSequence headerText) {
            materialIntroView.enableInfoDialog(true);
            materialIntroView.setTextViewHeader(headerText);
            return this;
        }
        ...
        public Builder setHeaderTextSize(int textSize) {
            materialIntroView.setTextViewHeaderSize(textSize);
            return this;
        }
